...
public class HomePagePositiveTests extends BaseTest {
    ...
    public void validatePressOnTrendingNowPart() {
        ...
        softAssert.assertEquals(urlAfterPressedOnTrendingNoePart,
                UrlHomeProvider.TRENDING_PAGE_URL.getUrl());
        softAssert.assertAll();
    }
    ...
    public void validatePressOnOurTopPicksPart() {
        ...
        softAssert.assertEquals(urlAfterPressedOnOurTopPicksPart,
                UrlHomeProvider.OUR_TOP_PICKS_PAGE_URL.getUrl());
        softAssert.assertAll();
    }
    ...
    public void validatePressOnNewReleasesPart() {
        ...
        softAssert.assertEquals(urlAfterPressedOnNewReleasesPart,
                UrlHomeProvider.NEW_RELEASES_PAGE_URL.getUrl());
        softAssert.assertAll();
    }
    ...
    public void validatePressOnTopFictionPart() {
        ...
        softAssert.assertEquals(urlAfterPressedOnTopFictionPart,
                UrlHomeProvider.TOP_FICTION_PAGE_URL.getUrl());
        softAssert.assertAll();
    }
