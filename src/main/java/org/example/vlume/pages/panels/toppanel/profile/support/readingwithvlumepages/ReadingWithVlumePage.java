package org.example.vlume.pages.panels.toppanel.profile.support.readingwithvlumepages;

import org.openqa.selenium.WebDriver;
import org.openqa.selenium.WebElement;
import org.openqa.selenium.support.FindBy;

public class ReadingWithVlumePage extends ReadingWithVlumePageDiv {
    ...
    public boolean readingWithVlumePageIsLoaded() {
        return super.pageIsLoaded(this.readingWithVlume, this.installingVlumeApp,
                this.webBrowserAccess, this.exploreMore);
    }
}
